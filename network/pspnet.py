...
def PSPNet_v1_rx101wod(num_classes, criterion):
    """
    ResNet-50 Based Network
    """
    return PSPNet(num_classes, trunk='resnext-101-32x8', criterion=criterion, variant='D')

def PSPNet_D16_v1_r50(num_classes, criterion):
    """
    ResNet-50 Based Network
    """
    return PSPNet(num_classes, trunk='resnet-50-deep', criterion=criterion, variant='D16')